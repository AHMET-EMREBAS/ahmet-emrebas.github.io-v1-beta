...
@RestController({
  secure: true,
  resource: 'ownnotification',
})
export class NotificationOwnController {
  constructor(private readonly dataService: NotificationService) {}

  @PostOwnReq()
  createOwn(
    @ReqBody() createDTO: CreateNotificationDto,
  ...
  @GetOwnReq()
  findAllOwn(
    @ReqQuery() query: QueryDTO<Notification>,
    @ReqUser() user: IUserEntity
  ) {
  ...
  updateOwn(
    @IDParam() id: number,
    @ReqBody() updateDTO: UpdateNotificationDto,
    @ReqUser() user: IUserEntity
  ) {
  ...
  async softDeleteOwn(
    @IDParam() id: number,
    @Query() query: QueryDTO<Notification>,
    @ReqUser() user: IUserEntity
  ) {
